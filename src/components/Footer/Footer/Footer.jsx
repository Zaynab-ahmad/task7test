  ...
  return (
    <>
      ...
      <div className="exContainer position-relative py-4">
        ...
        {location.pathname === '/about' && <AboutFooter />}
          <Row className="footer">
            ...
            <Col xs={12} lg={2} mx-lg-2>
              <h3 className="my-4 fs-6">Quick Links</h3>
              <p className="py-2" style={{ fontSize: "12px" }}>
            ...
            <Col xs={12} lg={3}>
              <h3 className="my-4 fs-6">Resent Posts</h3>
              ...
              <div className="d-flex">
                ...
                <div className="m-2" style={{ textAlign: "start" }}>
                  ...
                  <p className="my-0"> Top Most 5 Famous Technology trends</p>
                </div>
              </div>
            ...
            <Col xs={12} lg={4}>
              <h3 className="my-4 fs-6">Contact Us</h3>
              <form>
                <p>
